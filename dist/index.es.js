...
function getDevFormat() {
    ...
    return format.combine(format.timestamp({ format: 'YYYY/MM/DD HH:mm:ss' }), format.printf(function (info) {
...
var createWinstonLogger = function (options) { return createLogger(options); };
var stoolie = function (level, loggerOptions) {
    ...
    var options = loggerOptions
        ? loggerOptions
        : {
            transports: [new transports.Console({ format: format })],
        };
